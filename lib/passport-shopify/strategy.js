...
function Strategy(options, verify) {
  options = options || {};
  // if (!options.shopName) { throw new TypeError('shopName option is required!'); }
  ...
  defaultTokenURL = 'https://myshopify.com/admin/oauth/access_token';
  ...
  this.name = 'shopify';
  defaultProfileURL = 'https://myshopify.com/admin/shop';
