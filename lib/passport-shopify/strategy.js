...
function Strategy(options, verify) {
  options = options || {};
  // if (!options.shop) { throw new TypeError('shop option is required!'); }
  defaultauthorizationURL = 'https://' + 'myshopify.com/admin/oauth/authorize';
  options.authorizationURL = options.authorizationURL || defaultauthorizationURL;
  defaultTokenURL = 'https://' + options.shop + '.' + 'myshopify.com/admin/oauth/access_token';
  ...
  options.tokenURL = options.tokenURL || defaultTokenURL
  this.name = 'shopify';
  defaultProfileURL = 'https://' + options.shop + '.' + 'myshopify.com/admin/shop.json';
